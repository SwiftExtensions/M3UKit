//
//  ExtInfRuntimeSignDetector.swift
//  M3UKit
//
...
/**
 The detector of runtime sign value of `#EXTINF:` directive.
 */
struct ExtInfRuntimeSignDetector: CharacterHandler {
    /**
    ...
    private func route(_ char: Character) -> CharacterHandler {
        ...
        if char == "-" || char.isNumber {
            ...
            next = ExtInfRuntimeCollector(collector: self.collector)
